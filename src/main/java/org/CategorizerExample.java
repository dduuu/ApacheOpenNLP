...
public class CategorizerExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            BufferedOutputStream modelOut = new BufferedOutputStream(new FileOutputStream("en-pos-maxent.bin"));
            model.serialize(modelOut);
            System.out.println("Trained Model is saved locally at : "+"en-pos-maxent.bin");
            ...
            System.out.println("---------------------------------Category : Probability---------------------------------");
